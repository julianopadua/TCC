# Audit: `modeling` — 20260424_151957

- **Status:** **OK**
- **Total files:** 132
- **OK:** 120
- **Soft dup (multi-foco genuino, <1.10x):** 12
- **Duplicated (bug, >=1.10x):** 0
- **No keys:** 0
- **Error:** 0
- **Empty:** 0
...
| `inmet_bdq_2021_cerrado.parquet` | 1,831,958 | 1,708,005 | 1.0726x | SOFT_DUP | minor multi-foco overhead (genuino) |
...
| `inmet_bdq_2021_cerrado.parquet` | 1,837,452 | 1,708,005 | 1.0758x | SOFT_DUP | minor multi-foco overhead (genuino) |
