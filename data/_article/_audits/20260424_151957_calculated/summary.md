# Audit: `calculated` — 20260424_151957

- **Status:** **FAIL**
- **Total files:** 132
- **OK:** 102
- **Soft dup (multi-foco genuino, <1.10x):** 25
- **Duplicated (bug, >=1.10x):** 5
- **No keys:** 0
- **Error:** 0
- **Empty:** 0

## `base_A_no_rad_calculated`  (22/22 OK)
...
| `inmet_bdq_2020_cerrado.parquet` | 1,786,132 | 1,695,119 | 1.0537x | SOFT_DUP | minor multi-foco overhead (genuino) |
| `inmet_bdq_2021_cerrado.parquet` | 1,855,732 | 1,708,005 | 1.0865x | SOFT_DUP | minor multi-foco overhead (genuino) |
| `inmet_bdq_2022_cerrado.parquet` | 1,660,882 | 1,567,861 | 1.0593x | SOFT_DUP | minor multi-foco overhead (genuino) |
...
## `base_B_no_rad_knn_calculated`  (20/22 OK)
...
| `inmet_bdq_2020_cerrado.parquet` | 1,853,320 | 1,695,119 | 1.0933x | SOFT_DUP | minor multi-foco overhead (genuino) |
...
| `inmet_bdq_2024_cerrado.parquet` | 1,690,657 | 1,572,157 | 1.0754x | SOFT_DUP | minor multi-foco overhead (genuino) |
...
## `base_D_with_rad_drop_rows_calculated`  (22/22 OK)
...
| `inmet_bdq_2021_cerrado.parquet` | 29,936 | 28,169 | 1.0627x | SOFT_DUP | minor multi-foco overhead (genuino) |
...
## `base_E_with_rad_knn_calculated`  (19/22 OK)
...
| `inmet_bdq_2019_cerrado.parquet` | 1,794,582 | 1,684,823 | 1.0651x | SOFT_DUP | minor multi-foco overhead (genuino) |
...
| `inmet_bdq_2023_cerrado.parquet` | 1,040,676 | 972,249 | 1.0704x | SOFT_DUP | minor multi-foco overhead (genuino) |
| `inmet_bdq_2024_cerrado.parquet` | 1,726,910 | 1,572,157 | 1.0984x | SOFT_DUP | minor multi-foco overhead (genuino) |

## `base_F_full_original_calculated`  (22/22 OK)
