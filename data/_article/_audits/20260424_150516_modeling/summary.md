# Audit: `modeling` — 20260424_150516
...
| `inmet_bdq_2019_cerrado.parquet` | 1,719,564 | 1,684,823 | 1.0206x | DUPLICATED |  |
| `inmet_bdq_2020_cerrado.parquet` | 1,760,288 | 1,695,119 | 1.0384x | DUPLICATED |  |
| `inmet_bdq_2021_cerrado.parquet` | 1,831,958 | 1,708,005 | 1.0726x | DUPLICATED |  |
| `inmet_bdq_2022_cerrado.parquet` | 1,642,895 | 1,567,861 | 1.0479x | DUPLICATED |  |
| `inmet_bdq_2023_cerrado.parquet` | 993,960 | 972,249 | 1.0223x | DUPLICATED |  |
| `inmet_bdq_2024_cerrado.parquet` | 1,621,888 | 1,572,157 | 1.0316x | DUPLICATED |  |
...
| `inmet_bdq_2019_cerrado.parquet` | 1,721,402 | 1,684,823 | 1.0217x | DUPLICATED |  |
| `inmet_bdq_2020_cerrado.parquet` | 1,767,733 | 1,695,119 | 1.0428x | DUPLICATED |  |
| `inmet_bdq_2021_cerrado.parquet` | 1,837,452 | 1,708,005 | 1.0758x | DUPLICATED |  |
| `inmet_bdq_2022_cerrado.parquet` | 1,643,294 | 1,567,861 | 1.0481x | DUPLICATED |  |
| `inmet_bdq_2023_cerrado.parquet` | 995,058 | 972,249 | 1.0235x | DUPLICATED |  |
| `inmet_bdq_2024_cerrado.parquet` | 1,622,986 | 1,572,157 | 1.0323x | DUPLICATED |  |
