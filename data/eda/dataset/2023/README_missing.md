# Auditoria de dados faltantes - 2023

Este diretorio contem a auditoria de valores faltantes nas colunas de feature do arquivo consolidado `inmet_bdq_2023_cerrado.csv`.

## Resumo geral

- Linhas totais: 1944498
- Linhas com foco (HAS_FOCO == 1): 8068
- Proporcao de focos: 0.0041
...
| --- | ------------- | ----------------- |
| RADIACAO GLOBAL (KJ/m²) | 913538 | 0.4698 |
| PRECIPITAÇÃO TOTAL, HORÁRIO (mm) | 464378 | 0.2388 |
| VENTO, DIREÇÃO HORARIA (gr) (° (gr)) | 359518 | 0.1849 |
| VENTO, RAJADA MAXIMA (m/s) | 333084 | 0.1713 |
| VENTO, VELOCIDADE HORARIA (m/s) | 331236 | 0.1703 |