# Auditoria de dados faltantes - 2019

Este diretorio contem a auditoria de valores faltantes nas colunas de feature do arquivo consolidado `inmet_bdq_2019_cerrado.csv`.

## Resumo geral

- Linhas totais: 3378380
- Linhas com foco (HAS_FOCO == 1): 11492
...
| --- | ------------- | ----------------- |
| RADIACAO GLOBAL (KJ/m²) | 1655452 | 0.4900 |
| PRECIPITAÇÃO TOTAL, HORÁRIO (mm) | 504976 | 0.1495 |
| VENTO, DIREÇÃO HORARIA (gr) (° (gr)) | 468860 | 0.1388 |
| UMIDADE RELATIVA DO AR, HORARIA (%) | 463474 | 0.1372 |
| TEMPERATURA DO PONTO DE ORVALHO (°C) | 463084 | 0.1371 |