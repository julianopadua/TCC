# Auditoria de dados faltantes - 2022

Este diretorio contem a auditoria de valores faltantes nas colunas de feature do arquivo consolidado `inmet_bdq_2022_cerrado.csv`.

## Resumo geral

- Linhas totais: 3153240
- Linhas com foco (HAS_FOCO == 1): 10628
...
| --- | ------------- | ----------------- |
| RADIACAO GLOBAL (KJ/m²) | 1780724 | 0.5647 |
| PRECIPITAÇÃO TOTAL, HORÁRIO (mm) | 1047572 | 0.3322 |
| VENTO, DIREÇÃO HORARIA (gr) (° (gr)) | 940090 | 0.2981 |
| VENTO, RAJADA MAXIMA (m/s) | 924790 | 0.2933 |
| VENTO, VELOCIDADE HORARIA (m/s) | 920428 | 0.2919 |