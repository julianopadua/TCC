# Auditoria de dados faltantes - 2006

Este diretorio contem a auditoria de valores faltantes nas colunas de feature do arquivo consolidado `inmet_bdq_2006_cerrado.csv`.

## Resumo geral

- Linhas totais: 302130
- Linhas com foco (HAS_FOCO == 1): 1236
...
| --- | ------------- | ----------------- |
| RADIACAO GLOBAL (KJ/m²) | 138396 | 0.4581 |
| VENTO, RAJADA MAXIMA (m/s) | 12836 | 0.0425 |
| VENTO, DIREÇÃO HORARIA (gr) (° (gr)) | 12770 | 0.0423 |
| VENTO, VELOCIDADE HORARIA (m/s) | 12770 | 0.0423 |
| TEMPERATURA DO PONTO DE ORVALHO (°C) | 7658 | 0.0253 |