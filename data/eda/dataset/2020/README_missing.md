# Auditoria de dados faltantes - 2020

Este diretorio contem a auditoria de valores faltantes nas colunas de feature do arquivo consolidado `inmet_bdq_2020_cerrado.csv`.

## Resumo geral

- Linhas totais: 3407804
- Linhas com foco (HAS_FOCO == 1): 11388
...
| --- | ------------- | ----------------- |
| RADIACAO GLOBAL (KJ/m²) | 1874794 | 0.5501 |
| PRECIPITAÇÃO TOTAL, HORÁRIO (mm) | 1000124 | 0.2935 |
| VENTO, DIREÇÃO HORARIA (gr) (° (gr)) | 837616 | 0.2458 |
| VENTO, RAJADA MAXIMA (m/s) | 833364 | 0.2445 |
| VENTO, VELOCIDADE HORARIA (m/s) | 829968 | 0.2435 |