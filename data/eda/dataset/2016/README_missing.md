# Auditoria de dados faltantes - 2016

Este diretorio contem a auditoria de valores faltantes nas colunas de feature do arquivo consolidado `inmet_bdq_2016_cerrado.csv`.

## Resumo geral

- Linhas totais: 2583240
- Linhas com foco (HAS_FOCO == 1): 8854
...
| --- | ------------- | ----------------- |
| RADIACAO GLOBAL (KJ/m²) | 1181582 | 0.4574 |
| PRECIPITAÇÃO TOTAL, HORÁRIO (mm) | 180420 | 0.0698 |
| VENTO, RAJADA MAXIMA (m/s) | 64160 | 0.0248 |
| VENTO, DIREÇÃO HORARIA (gr) (° (gr)) | 62158 | 0.0241 |
| VENTO, VELOCIDADE HORARIA (m/s) | 62102 | 0.0240 |