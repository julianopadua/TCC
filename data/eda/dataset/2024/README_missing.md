# Auditoria de dados faltantes - 2024

Este diretorio contem a auditoria de valores faltantes nas colunas de feature do arquivo consolidado `inmet_bdq_2024_cerrado.csv`.

## Resumo geral

- Linhas totais: 3161880
- Linhas com foco (HAS_FOCO == 1): 12740
- Proporcao de focos: 0.0040
...
| --- | ------------- | ----------------- |
| RADIACAO GLOBAL (KJ/m²) | 1566302 | 0.4954 |
| PRECIPITAÇÃO TOTAL, HORÁRIO (mm) | 816768 | 0.2583 |
| VENTO, DIREÇÃO HORARIA (gr) (° (gr)) | 642674 | 0.2033 |
| TEMPERATURA DO PONTO DE ORVALHO (°C) | 641768 | 0.2030 |
| VENTO, RAJADA MAXIMA (m/s) | 628774 | 0.1989 |