# Auditoria de dados faltantes - 2007

Este diretorio contem a auditoria de valores faltantes nas colunas de feature do arquivo consolidado `inmet_bdq_2007_cerrado.csv`.

## Resumo geral

- Linhas totais: 1181586
- Linhas com foco (HAS_FOCO == 1): 5902
...
| --- | ------------- | ----------------- |
| RADIACAO GLOBAL (KJ/m²) | 532278 | 0.4505 |
| UMIDADE RELATIVA DO AR, HORARIA (%) | 20410 | 0.0173 |
| TEMPERATURA DO PONTO DE ORVALHO (°C) | 20382 | 0.0172 |
| VENTO, DIREÇÃO HORARIA (gr) (° (gr)) | 5798 | 0.0049 |
| VENTO, RAJADA MAXIMA (m/s) | 3874 | 0.0033 |