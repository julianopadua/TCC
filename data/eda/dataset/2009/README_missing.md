# Auditoria de dados faltantes - 2009

Este diretorio contem a auditoria de valores faltantes nas colunas de feature do arquivo consolidado `inmet_bdq_2009_cerrado.csv`.

## Resumo geral

- Linhas totais: 2185516
- Linhas com foco (HAS_FOCO == 1): 5076
- Proporcao de focos: 0.0023
...
| --- | ------------- | ----------------- |
| RADIACAO GLOBAL (KJ/m²) | 902028 | 0.4127 |
| VENTO, DIREÇÃO HORARIA (gr) (° (gr)) | 91688 | 0.0420 |
| VENTO, RAJADA MAXIMA (m/s) | 51782 | 0.0237 |
| VENTO, VELOCIDADE HORARIA (m/s) | 50776 | 0.0232 |
| TEMPERATURA DO PONTO DE ORVALHO (°C) | 9330 | 0.0043 |