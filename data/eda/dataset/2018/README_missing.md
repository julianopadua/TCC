# Auditoria de dados faltantes - 2018

Este diretorio contem a auditoria de valores faltantes nas colunas de feature do arquivo consolidado `inmet_bdq_2018_cerrado.csv`.

## Resumo geral

- Linhas totais: 3053532
- Linhas com foco (HAS_FOCO == 1): 7732
- Proporcao de focos: 0.0025
...
| --- | ------------- | ----------------- |
| RADIACAO GLOBAL (KJ/m²) | 1367872 | 0.4480 |
| PRECIPITAÇÃO TOTAL, HORÁRIO (mm) | 160164 | 0.0525 |
| TEMPERATURA DO PONTO DE ORVALHO (°C) | 106150 | 0.0348 |
| UMIDADE RELATIVA DO AR, HORARIA (%) | 102062 | 0.0334 |
| VENTO, RAJADA MAXIMA (m/s) | 43314 | 0.0142 |