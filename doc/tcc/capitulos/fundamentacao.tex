...
\subsection{Por que o Cerrado?}
\label{subsec:porque-o-cerrado}

O Cerrado combina longa estiagem, combustível fino abundante e resposta rápida às condições de temperatura, umidade e vento, com pico de queima concentrado em janela curta e previsível. É, ademais, o maior contribuinte para a área queimada anual do Brasil e da América do Sul, de modo que concentrar o escopo nesse bioma maximiza relevância prática e coerência ecológica do modelo \cite{silva2025climatic,pivello2011use}.

Do ponto de vista epistemológico, esse recorte evita misturar mecanismos savânicos, nos quais o clima sazonal domina, com mecanismos florestais úmidos mais sensíveis à fragmentação e à ignição antrópica. Também alinha o desenho do estudo às recomendações da literatura de regimes de fogo por ecossistema, que ressalta a necessidade de estratégias analíticas e de manejo diferenciadas por bioma \cite{ramalho2024compreendendo,viegas2022fireclimate}.
